(function attachProductDto(global) {
  ...
  function mapPublicProductForClient(product, options = {}) {
    ...
    return stripCustomerSensitiveProductFields({
      ...
      memberUnitPrice: includeMemberPrices ? product?.memberUnitPrice : undefined,
      memberPriceLabel: includeMemberPrices ? product?.memberPriceLabel : undefined,
      memberGrade: includeMemberPrices ? product?.memberGrade : undefined,
